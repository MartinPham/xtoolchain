...
COPY sdks/SDK-B288-6.3.upd2.7z /app/SDK-B288-6.3.upd2.7z

RUN apt install -y p7zip-full

RUN 7z x -aoa -y SDK-B288-6.3.upd2.7z -oSDK_6.3.0 && rm -rf SDK-B288-6.3.upd2.7z
