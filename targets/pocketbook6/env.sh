...
# pocketbook
export DEV_SDK=SDK_6.3.0/SDK-B288
export DEV_SDK_PATH=${BUILDROOT}/${DEV_SDK}
export DEV_SDK_TOOLCHAIN_PREFIX=arm-obreey-linux-gnueabi
export DEV_SDK_SYSROOT=${DEV_SDK_PATH}/usr/${DEV_SDK_TOOLCHAIN_PREFIX}/sysroot
export DEV_SDK_TOOLCHAIN_BIN_PATH=${DEV_SDK_PATH}/usr/bin
export DEV_SDK_CSTOOLS=${DEV_SDK_SYSROOT}/usr
export DEV_SDK_PREFIX=/mnt/ext1/system
...
export LDFLAGS="-L${CSTOOLS_LIB} -Wl,-rpath,/mnt/ext1/system/lib -Wl,-rpath-link,${CSTOOLS_LIB} -Wl,-O1 -Wl,--hash-style=gnu"
...
mkdir -p /srv/jenkins/workspace/SDK-GEN/output-B288
rm -rf /srv/jenkins/workspace/SDK-GEN/output-B288/host
ln -s ${BUILDROOT}/${PBSDK} /srv/jenkins/workspace/SDK-GEN/output-B288/host
